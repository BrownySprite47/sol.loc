...
class TemplateProcessor
{
    ...
    public function cloneBlock($blockname, $clones = 1, $replace = true)
    {
        $xmlBlock = null;
        preg_match(
            '/(<w:p><w:pPr><w:pStyle w:val="Normal"\/><w:rPr><\/w:rPr><\/w:pPr><w:r><w:rPr><\/w:rPr><w:t>\$\{' . $blockname. '\}<\/w:t><\/w:r><\/w:p>)(.*)(<w:p><w:pPr><w:pStyle w:val="Normal"\/><w:rPr><\/w:rPr><\/w:pPr><w:r><w:rPr><\/w:rPr><w:t>\$\{\/' . $blockname. '\}<\/w:t><\/w:r><\/w:p>)/is',
