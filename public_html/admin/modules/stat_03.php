...
";      }    }
    ...
    $aData["content"]["filial_ids"] = "";

    if(isset($aData["filials"]) and !empty($aData["filials"]))
    {
      foreach($aData["filials"] as $iTemp => $aFilial)
      {
      	if(isset($aFilial["filial_id"]) and !is_null($aFilial["filial_id"]))
      	{
      	  $iFilialId = $aFilial["filial_id"];
      	}
      	else
      	{
      	  $iFilialId  = "";
      	...
      	$aData["content"]["filial_ids"] .= ($iTemp + 1) . ". " . $iFilialId . "
";
      }
    }

    $aData["content"]["filial_ids"] = trim($aData["content"]["filial_ids"]);
