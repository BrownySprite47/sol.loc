...
if(isset($_GET["content_id"]) and bIsInt($_GET["content_id"], 1))
{
  ...
  $aSql[] = "INSERT INTO
  " . DB_PREFIX . "leaders (leader_surname, leader_name, leader_patronymic, leader_create_backend_user_id, leader_create_datetime, leader_enabled, leader_create_date)
SELECT
  ...
  1 AS leader_enabled,
  DATE(NOW()) AS leader_create_date
FROM
