<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-03 20:37:55
         compiled from "C:\OSPanel\domains\localhost\sol.loc\public_html\admin\templates\backend_projects_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:211185a1fbfdde1a935-32621894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec0493ea3a52dc16cb4d407fd31ae341139830d9' => 
    array (
      0 => 'C:\\OSPanel\\domains\\localhost\\sol.loc\\public_html\\admin\\templates\\backend_projects_list.tpl',
      1 => 1512035418,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '211185a1fbfdde1a935-32621894',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a1fbfde145611_84702640',
  'variables' => 
  array (
    'bProjectsEdit' => 0,
    'aSearch' => 0,
...
<?php if ($_valid && !is_callable('content_5a1fbfde145611_84702640')) {function content_5a1fbfde145611_84702640($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:/OSPanel/domains/localhost/sol.loc/public_html/admin/libs/Smarty/plugins\\function.cycle.php';
?><?php if ($_smarty_tpl->tpl_vars['bProjectsEdit']->value) {?><div class="sub_links">
...
<td>
<div class="wrap_input inline_input">
<input id="project_done_type_1" type="radio" name="project_done_type_id" value="1"<?php if ($_smarty_tpl->tpl_vars['aSearch']->value['project_done_type_id']=="1") {?> checked="checked"<?php }?> /> <label for="project_done_type_1">все</label>
</div>
<div class="wrap_input inline_input">
<input id="project_done_type_2" type="radio" name="project_done_type_id" value="2"<?php if ($_smarty_tpl->tpl_vars['aSearch']->value['project_done_type_id']=="2") {?> checked="checked"<?php }?> /> <label for="project_done_type_2">заполенные анкеты</label>
</div>
<div class="wrap_input inline_input">
<input id="project_done_type_3" type="radio" name="project_done_type_id" value="3"<?php if ($_smarty_tpl->tpl_vars['aSearch']->value['project_done_type_id']=="3") {?> checked="checked"<?php }?> /> <label for="project_done_type_3">незаполненные анкеты</label>
</div>
</td>
</tr>
<tr<?php echo smarty_function_cycle(array('name'=>"content_data",'values'=>' class="odd",'),$_smarty_tpl);?>
...
<div class="wrap_input inline_input">
<input id="project_enabled_type_2" type="radio" name="project_enabled_type_id" value="2"<?php if ($_smarty_tpl->tpl_vars['aSearch']->value['project_enabled_type_id']=="2") {?> checked="checked"<?php }?> /> <label for="project_enabled_type_2">актуальные</label>
</div>
<div class="wrap_input inline_input">
<input id="project_enabled_type_3" type="radio" name="project_enabled_type_id" value="3"<?php if ($_smarty_tpl->tpl_vars['aSearch']->value['project_enabled_type_id']=="3") {?> checked="checked"<?php }?> /> <label for="project_enabled_type_3">неактуальные</label>
</div>
</td>
</tr>
</tbody>
...
<?php if ($_smarty_tpl->tpl_vars['bProjectsEdit']->value) {?><th class="small"></th><?php }?>
</tr>
</thead>
<tbody>
<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
...
if ($_smarty_tpl->tpl_vars['item']->value['project_enabled']==0) {?> disable<?php }?>">
...
index.php?module_name=projects&action_name=view<?php if (!$_smarty_tpl->tpl_vars['bProjectsEdit']->value) {?>_without_edit<?php }?>&content_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['project_id'];?>
...
" target="_blank">URL</a><?php } else {
echo $_smarty_tpl->tpl_vars['item']->value['project_site'];
}?></td>
<td><?php if ($_smarty_tpl->tpl_vars['item']->value['project_done']==1) {?>+<?php } else { ?>-<?php }?></td>
<?php if ($_smarty_tpl->tpl_vars['bProjectsEdit']->value) {?><td><a target="_blank" href="<?php echo $_smarty_tpl->getConfigVariable('PROJECT_BACKEND_URL');?>
index.php?module_name=projects&action_name=view_without_edit&content_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['project_id'];?>
