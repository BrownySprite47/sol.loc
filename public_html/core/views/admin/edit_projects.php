...
<?php if ($_SESSION['role'] == 'admin'): ?>
    <?php 
    $title = 'Отредактированные проекты';
                    ...
                    <div id="panel4">
                        <div class="list-group">                            
                            <div class="list-group-item title_menu_admin">
                                <h2>ОТРЕДАКТИРОВАННЫЕ ПРОЕКТЫ</h2>
                            </div>
                            <?php if(!empty($data['getProjectsAdmin_edit'])): ?>
                                <?php foreach ($data['getProjectsAdmin_edit'] as $key => $value): ?>
                            ...
                            <?php else: ?>
                                <div class="list-group-item col-lg-12">
                                    <h3 class="title">Нет отредактированных проектов</h3>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
