...
if($oResult = $oDB->query($sSql))
{
  while($aRow = $oResult->fetch_assoc())
  {
    ...
    {      $aRecommendations[$aRow["leader_id_from"]] = array("recommendations_from_count" => 0, "recommendations_to_count" => 0, "leader_ids" => array(), "leader_names" => array(), "leader_ids_from" => array(), "leaders_names_from" => array());    }
    ...
    if($aRow["leader_id_to"] !== "")
    {      if(!isset($aRecommendations[$aRow["leader_id_to"]]))
      {      	$aRecommendations[$aRow["leader_id_to"]] = array("recommendations_from_count" => 0, "recommendations_to_count" => 0, "leader_ids" => array(), "leader_names" => array(), "leader_ids_from" => array(), "leaders_names_from" => array());      }
...
$aFields["leader_names"] = "Лидеры ЛИСС (наименования)";
