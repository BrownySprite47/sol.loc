...
if(isset($_GET["content_id"]) and bIsInt($_GET["content_id"], 1))
{
  ...
  $aSql[] = "INSERT INTO
  " . DB_PREFIX . "leaders (leader_surname, leader_name, leader_patronymic, leader_email, leader_phone, city_id, leader_city_name, leader_create_backend_user_id, leader_create_datetime, leader_enabled)
SELECT
  r.leader_surname,
  r.leader_name,
