...
{  $aWhere[] = "l.leader_create_datetime >= '" . $aSearch["date_from"] . "'";}

if($aSearch["date_to"] !== "")
{
  $aWhere[] = "l.leader_create_datetime < '" . $aSearch["date_to"] . "' + INTERVAL 1 DAY";
}
...
$aOrderTypes[5] = "city_name_show, l.leader_create_datetime, l.leader_id";
$aOrderTypes[6] = "city_name_show DESC, l.leader_create_datetime DESC, l.leader_id DESC";
...
$sSql = "SELECT
  ...
  COALESCE(GROUP_CONCAT(DISTINCT IF(cov.option_value_id IS NULL, NULL, ov_4.option_value) ORDER BY ov_4.option_order, ov_4.option_value SEPARATOR ', '), '') AS leader_option_4,
  COALESCE(ov_1.option_value, '') AS leader_option_1,
