<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-11-25 13:08:19
         compiled from "C:\OSPanel\domains\localhost\sol.loc\public_html\user\templates\backend_projects_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151955a194113af65a9-09241045%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '651a7b7d96fbf98cfa954e84de8ef7250e1f60c2' => 
    array (
      0 => 'C:\\OSPanel\\domains\\localhost\\sol.loc\\public_html\\user\\templates\\backend_projects_view.tpl',
      1 => 1504465006,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151955a194113af65a9-09241045',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a1941142b47b0_85974525',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a1941142b47b0_85974525')) {function content_5a1941142b47b0_85974525($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:/OSPanel/domains/localhost/sol.loc/public_html/user/libs/Smarty/plugins\\function.cycle.php';
...
?><div class="sub_links">
<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value['project_id'])) {?><a href="<?php echo $_smarty_tpl->getConfigVariable('PROJECT_BACKEND_URL');?>
...
}?> (<?php echo $_smarty_tpl->tpl_vars['aContentData']->value['leader_id'];?>
)</a></td>
<?php }?>
...
<td colspan="2"><input type="checkbox" name="project_enabled"<?php if (!isset($_smarty_tpl->tpl_vars['aContentData']->value)||$_smarty_tpl->tpl_vars['aContentData']->value['project_enabled']==1) {?> checked<?php }?> /></td>
</tr>
</tbody>
</table>
...
<div class="options_add open" for="leaders">Лидеры проекта (<?php if (isset($_smarty_tpl->tpl_vars['aLeaders']->value)) {
...
>
$(function(){
  $("#project_date_from_<?php echo $_smarty_tpl->tpl_vars['item']->value['leader_project_id'];?>
").datepicker({
      changeMonth: true,
      changeYear: true,
      dateFormat: "yy-mm-dd",
  ...
  $("#project_date_to_<?php echo $_smarty_tpl->tpl_vars['item']->value['leader_project_id'];?>
").datepicker({
      changeMonth: true,
      changeYear: true,
      dateFormat: "yy-mm-dd",
