<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-11-25 13:08:24
         compiled from "C:\OSPanel\domains\localhost\sol.loc\public_html\user\templates\backend_leaders_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:122805a194118d16939-79063942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e8305a71a2e675a72ec55179bf20e996fd5c209b' => 
    array (
      0 => 'C:\\OSPanel\\domains\\localhost\\sol.loc\\public_html\\user\\templates\\backend_leaders_view.tpl',
      1 => 1504465005,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '122805a194118d16939-79063942',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a1941193ae748_51943742',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a1941193ae748_51943742')) {function content_5a1941193ae748_51943742($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:/OSPanel/domains/localhost/sol.loc/public_html/user/libs/Smarty/plugins\\function.cycle.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:/OSPanel/domains/localhost/sol.loc/public_html/user/libs/Smarty/plugins\\modifier.date_format.php';
?><div class="sub_links">
<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value['leader_id'])) {?><a href="<?php echo $_smarty_tpl->getConfigVariable('PROJECT_BACKEND_URL');?>
...
}?> (<?php echo $_smarty_tpl->tpl_vars['item']->value['leader_id'];?>
)</a><br/><?php } ?></td>
</tr>
<?php }?>
<tr<?php echo smarty_function_cycle(array('name'=>"content_data_01",'values'=>' class="odd",'),$_smarty_tpl);?>
...
}?>" class="small" id="leader_birth_date" /> <input id="leader_birth_date_correct" type="checkbox" name="leader_birth_date_correct"<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value)&&$_smarty_tpl->tpl_vars['aContentData']->value['leader_birth_date_correct']==1) {?> checked<?php }?> /> <label for="leader_birth_date_correct">дата точная</label></td>
</tr>
<tr<?php echo smarty_function_cycle(array('name'=>"content_data_02",'values'=>' class="odd",'),$_smarty_tpl);?>
>
...
<div class="options_add open" for="block_03">Контакты</div>
...
<tr<?php echo smarty_function_cycle(array('name'=>"content_data_03",'values'=>' class="odd",'),$_smarty_tpl);?>
>
<td>Дополнительная контактная информация <div class="info"><span>Дополнительные контакты, такие как: телефон, e-mail, социальные сети и т. п.</span></div></td>
...
<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value['leader_id'])) {?>
<div class="options_add open" for="projects">Проекты (<?php if (isset($_smarty_tpl->tpl_vars['aProjects']->value)) {
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['item']->value['project_name'];?>
 (<?php echo $_smarty_tpl->tpl_vars['item']->value['project_id'];?>
)</a></td>
<?php } else { ?>
...
<div class="options_add open" for="block_04">Личные вопросы</div>
...
<div class="options_add open" for="block_05">Вызовы, препятствия и потребности</div>
...
<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value['leader_id'])) {?>
<div class="options_add open" for="leaders">Рекомендации (<?php echo $_smarty_tpl->tpl_vars['aContentData']->value['recommendations_to_count'];?>
...
<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value['leader_id'])&&$_smarty_tpl->tpl_vars['bRecommendationDeleteEnabled']->value) {?><th class="small"></th><?php }?>
</tr>
...
<?php if (isset($_smarty_tpl->tpl_vars['aContentData']->value['leader_id'])&&$_smarty_tpl->tpl_vars['bRecommendationDeleteEnabled']->value) {?><td rowspan="6"></td><?php }?>
</tr>
<tr<?php if ($_smarty_tpl->tpl_vars['iTemp']->value==1) {?> class="odd"<?php }?>>
